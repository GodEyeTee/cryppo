...
```bash
python src/data/binance_downloader.py --symbol BTCUSDT --timeframe 1m --start 2024-01-01 --end 2024-12-31
python src/data/binance_downloader.py --symbol BTCUSDT --timeframe 5m --start 2023-01-01 --end 2023-12-31
```
